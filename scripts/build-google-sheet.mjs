...
writeTable(
  ...
  [
    ...
    ["Vestuario", "gasto_geral", true, ""],
    ["Pet", "gasto_geral", true, ""],
    ["Beleza", "gasto_geral", true, ""],
    ["Carro", "gasto_geral", true, ""],
    ["Manutencao", "gasto_geral", true, ""],
    ["Viagem", "gasto_geral", true, ""],
    ["Presentes", "gasto_geral", true, ""],
    ["Servicos", "gasto_geral", true, ""],
    ["Assinaturas", "gasto_geral", true, ""],
    ["Impostos", "despesa", true, ""],
    ["Seguros", "despesa", true, ""],
    ["Investimentos", "investimento", true, ""],
